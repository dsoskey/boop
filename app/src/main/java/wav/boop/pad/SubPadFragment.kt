...
import wav.boop.synth.engine.SynthEngine
import wav.boop.visualisation.ClassicOscilloscopeFragment

class SubPadFragment(
    private val parent: FragmentActivity,
    private val synthesizer: SynthEngine,
