...
class PadFragment(
    ...
    private val buttonToColor: Map<Int, Int>,
    ...
    private var frequencyMap: MutableMap<Int, Double>? = null
        ...
        when (actionMode) {
            ...
            PadAction.PLAY -> {
                if (event.action == MotionEvent.ACTION_DOWN) {
                    ...
                    setPadColor(buttonId, Color.valueOf(buttonToColor[buttonId]!!))
                } else if (event.action == MotionEvent.ACTION_UP ||
                    event.action == MotionEvent.ACTION_CANCEL ||
                    event.action == MotionEvent.ACTION_BUTTON_RELEASE
                ) {
                    synthesizer.audioEngine.stop(buttonId)
                    setPadColor(buttonId, Color.valueOf(Color.BLACK))
                }
            }
        }
        return true
